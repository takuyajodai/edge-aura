...
- Docs-only release — no engine or adapter code changes.
- Canonical URL is now **https://edge-aura.js.org** (README, `homepage`,
  demo OpenGraph tags).
- README hero is an animated APNG capture of the live demo (full-color;
  replaces the earlier static image on the npm page).
